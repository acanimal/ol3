...
goog.provide('ol.source.ClusterAnimated');
 ...
 * @api
 */
ol.source.ClusterAnimated = function(options) {
  goog.base(this, {
  ...
  this.source_.on(goog.events.EventType.CHANGE,
      ol.source.ClusterAnimated.prototype.onSourceChange_, this);
};
goog.inherits(ol.source.ClusterAnimated, ol.source.Vector);


/**
 * @inheritDoc
 */
ol.source.ClusterAnimated.prototype.loadFeatures = function(extent, resolution,
    projection) {
 ...
 * @private
 */
ol.source.ClusterAnimated.prototype.onSourceChange_ = function() {
  this.clear();
  this.cluster_();
  this.addFeatures(this.features_);
  this.changed();
 ...
 * @private
 */
ol.source.ClusterAnimated.prototype.cluster_ = function() {
 ...
 * @private
 */
ol.source.ClusterAnimated.prototype.createCluster_ = function(features) {
